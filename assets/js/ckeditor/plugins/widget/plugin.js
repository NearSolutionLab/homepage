...
( function() {
    ...
    var DRAG_HANDLER_CONTAINER_WIDTH = 30;
    var DRAG_HANDLER_CONTAINER_HEIGHT = 25;
		...
		onLoad: function() {
			...
			CKEDITOR.addCss(
				...
				'.cke_widget_drag_handler_container{' +
					'position:absolute;' +
					'width:' + DRAG_HANDLER_CONTAINER_WIDTH + 'px;' +
					'height:0;' +
...
//					'transition:height 0s 0.2s;' + // Delay hiding drag handler.
				...
				'.cke_widget_wrapper:hover>.cke_widget_drag_handler_container{' +
					'height:' + DRAG_HANDLER_CONTAINER_HEIGHT + 'px;' +
					'transition:none' +
				'}' +
                'img.cke_widget_drag_handler{' +
                    ...
                    'display:inline-block' +
                '}' +
                'img.cke_widget_drag_handler:hover{' +
                    'opacity:1;' +
                '}' +
				'.cke_widget_mask{' +
					'position:absolute;' +
		...
		if ( container )
			...
			container.setAttributes( {
				...
				// Split background and background-image for IE8 which will break on rgba().
 				style: 'background-color:#0e1b26;border-radius: 5px;'
			} );
			...
			img.setAttributes( {
				...
				src: editor.plugins.widget.path + 'images/handle.svg',
